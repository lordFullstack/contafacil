  ...
  return (
    <div className="pb-28 md:pb-10">
      <header className="px-5 pt-6 pb-4 md:px-0">
        ...
        <p className="text-sm text-slate-600">{customers.length} registrados · fiados (cuentas por cobrar)</p>
      </header>
                  ...
                  <div className="space-y-2">
                    {pending.map((cr) => (
                      <div key={cr.id} className="flex items-center justify-between text-sm">
                        <div>
                          <p className="text-slate-600">{cr.description || 'Fiado'}</p>
                          {cr.dueDate && (
                        ...
                        <div className="flex items-center gap-2">
                          <span className="font-mono text-slate-600">{formatCOP(cr.amount)}</span>
                          <button
                            onClick={() =>
