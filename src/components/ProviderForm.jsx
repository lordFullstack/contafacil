    ...
    <div className="fixed inset-0 z-40 flex items-end justify-center bg-black/60 backdrop-blur-sm">
      <div className="w-full max-w-md rounded-t-3xl border-t border-base-700 bg-base-900 p-5 pb-8">
        <div className="mb-4 flex items-center justify-between">
          <h2 className="font-display text-lg font-semibold text-slate-800">Nuevo proveedor</h2>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <label className="mb-1 block text-xs font-medium text-slate-500">Nombre / Razón social</label>
            <input
              type="text"
              required
              value={name}
          ...
          <div>
            <label className="mb-1 block text-xs font-medium text-slate-500">NIT (opcional)</label>
            <input
              type="text"
              value={nit}
          ...
          <div>
            <label className="mb-1 block text-xs font-medium text-slate-500">Teléfono (opcional)</label>
            <input
              type="tel"
              value={phone}
          ...
          <div>
            <label className="mb-1 block text-xs font-medium text-slate-500">Categoría (opcional)</label>
            <input
              type="text"
              value={category}
