    ...
    <div className="fixed inset-0 z-40 flex items-end justify-center bg-black/60 backdrop-blur-sm">
      <div className="w-full max-w-md rounded-t-3xl border-t border-base-700 bg-base-900 p-5 pb-8">
        <div className="mb-4 flex items-center justify-between">
          <h2 className="font-display text-lg font-semibold text-slate-800">Nuevo cliente</h2>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <label className="mb-1 block text-xs font-medium text-slate-500">Nombre del cliente</label>
            <input
              type="text"
              required
              value={name}
          ...
          <div>
            <label className="mb-1 block text-xs font-medium text-slate-500">Notas (opcional)</label>
            <input
              type="text"
              value={notes}
